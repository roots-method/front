...
window.CASE_STUDIES = {
  ...
  "multi-office-advisory-firm": {
    ...
    summary:
      "Month-end reporting consumed two full weeks across four locations. Arka standardized data capture, introduced approval checkpoints, and layered in light automation for recurring reconciliations.",
    teaser:
      "Month-end reporting consumed two full weeks across four locations. Arka standardized data capture, introduced approval checkpoints, and layered in light automation for recurring reconciliations freeing analysts to focus on review instead of assembly.",
    readTime: "7 min read",
  ...
  "agricultural-export-cooperative": {
    ...
    summary:
      "Traceability data was scattered across field notes, vendor emails, and legacy ERP exports. Arka unified the pipeline, added validation at each step, and gave operations a live picture of shipment readiness.",
    teaser:
      "Traceability data was scattered across field notes, vendor emails, and legacy ERP exports. Arka unified the pipeline, added validation at each step, and gave operations a live picture of shipment readiness without adding headcount.",
    readTime: "8 min read",
